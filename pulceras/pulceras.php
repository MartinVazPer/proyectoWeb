...
<body>
    ...
    <div class="product-container">
        <div class="product-card">
            <img src="../img/pulcera/pulcera1.png" alt="Producto 1">
            <a href="Aretes.php" class="btn btn-primary">Comprar</a>
        </div>
        <div class="product-card">
            <img src="../img/pulcera/pulcera2.png" alt="Producto 2">
            <a href="Aretes.php" class="btn btn-primary">Comprar</a>
        </div>
        <div class="product-card">
            <img src="../img/pulcera/pulcera3.png" alt="Producto 3">
            <a href="Aretes.php" class="btn btn-primary">Comprar</a>
        </div>
    </div>
    <div class="product-container">
        <div class="product-card">
            <img src="../img/pulcera/pulcera4.png" alt="Producto 4">
            <a href="Aretes.php" class="btn btn-primary">Comprar</a>
        </div>
        <div class="product-card">
            <img src="../img/pulcera/pulcera5.png" alt="Producto 5">
            <a href="Aretes.php" class="btn btn-primary">Comprar</a>
        </div>
        <div class="product-card">
            <img src="../img/pulcera/pulcera6.png" alt="Producto 6">
            <a href="Aretes.php" class="btn btn-primary">Comprar</a>
        </div>
    </div>
